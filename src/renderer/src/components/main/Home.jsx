...
const Home = () => {
  ...
  const completedProjects = useMemo(
    () =>
      projects.filter(
        (project) => project?.status?.toUpperCase() === "COMPLETE",
      )?.length || 0,
    [projects],
  );
  ...
  const inProgressTasks = useMemo(
    () =>
      tasks.filter((task) => task?.status?.toUpperCase() === "IN_PROGRESS")
        ?.length || 0,
    [tasks],
  );
                      ...
                      <div>
                        ...
                        <div className="flex items-center mt-2">
                          <span className="text-xs text-gray-500">
                            {completedProjects} completed · {inProgressProjects}{" "}
                            in progress
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="p-5">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <div className="flex items-center mt-2">
                          <span className="text-xs text-gray-500">
                            {completedTasks} completed · {inProgressTasks} in
                            progress
                          </span>
                        </div>
                      </div>
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-sm text-gray-500">
                                  Manager:{" "}
                                  {project.manager?.f_name || "Unassigned"}
                                </p>
                              </div>
                              <span
