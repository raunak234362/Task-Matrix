    ...
    <div className="bg-white/70 rounded-lg md:w-full w-[90vw] p-4">
      ...
      <div className="flex flex-col gap-4 mb-4 md:flex-row">
        <input
          ...
          className="w-full px-4 py-2 bg-white border rounded-md md:w-1/4"
        />
        <select
          value={statusFilter}
        ...
        <select
          ...
          className="w-full px-4 py-2 border bg-white rounded-md md:w-1/4"
        >
      ...
      {/* Project Table */}
      <div className="mt-5 bg-white h-[79vh] overflow-auto rounded-lg">
