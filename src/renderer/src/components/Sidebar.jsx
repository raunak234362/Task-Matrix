...
const Sidebar = ({ refresh, isMinimized, toggleSidebar }) => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      to:"projects",
      icon: <FolderOpenDot/>,
      roles: ["admin", "department-manager","deputy-manager", "project-manager", "user", "human-resource"],
    },
    {
      label: "Tasks",
      to: "tasks",
      icon: <ChartCandlestick />,
      roles: ["admin", "department-manager","deputy-manager", "project-manager", "user","system-admin", "human-resource"],
    },
    {
      label: "Estimations",
      to: "estimation",
      ...
      <div className="p-4 flex flex-col items-start">
        {!isMinimized && (
          <div >
            ...
            <div className="text-xs text-gray-500 mb-2">Version - 1.3.0</div>
          </div>
        )}
