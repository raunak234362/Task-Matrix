          ...
          <div className="flex mt-6 space-x-1">
            <button
              ...
              className={`px-4 py-2 rounded-t-lg font-medium transition-colors ${
                activeTab === "overview" ? "bg-white text-teal-700" : "bg-teal-600 text-white hover:bg-teal-500"
              }`}
            >
              Overview
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-t-lg font-medium transition-colors ${
                activeTab === "projects" ? "bg-white text-teal-700" : "bg-teal-600 text-white hover:bg-teal-500"
              }`}
            >
              Projects
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-t-lg font-medium transition-colors ${
                activeTab === "analytics" ? "bg-white text-teal-700" : "bg-teal-600 text-white hover:bg-teal-500"
              }`}
            >
              Analytics
            </button>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        {activeTab === "analytics" && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow-md lg:col-span-2">
              <div className="p-5 border-b">
                <h3 className="text-lg font-semibold text-gray-800">Project Performance</h3>
              </div>
              <div className="p-5">
                <div className="h-80">
                  <BarViews segregateProject={segregateProject} setProject={projects} setFabricator={fabricators} />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md">
              <div className="p-5 border-b">
                <h3 className="text-lg font-semibold text-gray-800">Project Status Summary</h3>
              </div>
              <div className="p-5">
                <div className="space-y-4">
                  ...
                  <div className="mt-8">
                    <h4 className="text-sm font-medium text-gray-700 mb-3">Project Type Distribution</h4>
                    <div className="space-y-2">
                      {Object.entries(segregateProject).map(([key, value], index) => (
                        <div key={key}>
                          <div className="flex justify-between mb-1">
                            <span className="text-xs text-gray-600">{key}</span>
                            <span className="text-xs text-gray-600">{value.length}</span>
                          </div>
                          <div className="w-full bg-gray-200 rounded-full h-1.5">
                            <div
                              ...
                              style={{ width: `${projects?.length ? (value.length / projects.length) * 100 : 0}%` }}
                            ></div>
                          </div>
                        </div>
                      ))}
